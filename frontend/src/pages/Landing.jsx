        ...
        <div className="min-h-screen relative overflow-y-auto overflow-x-hidden bg-black selection:bg-accent-500 selection:text-black" style={{ fontFamily: "'Inter', sans-serif" }}>
            ...
            <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-center px-6">
                ...
                <a href="https://wa.me/573218051869" target="_blank" rel="noreferrer" 
                   className="fixed bottom-16 right-8 z-[60] flex items-center gap-3 bg-emerald-500 text-black px-6 py-3.5 rounded-full font-black shadow-[0_10px_30px_rgba(16,185,129,0.4)] hover:scale-110 hover:shadow-[0_15px_40px_rgba(16,185,129,0.6)] transition-all duration-300 group">
